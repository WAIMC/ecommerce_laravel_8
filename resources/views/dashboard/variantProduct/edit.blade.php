    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4 class="text-center">Edit Variant Product</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-9">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="color" id="color" aria-describedby="color" placeholder="Color Name Product" value="{{ $variantProduct->color }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="color" name="color_code" id="color_code" aria-describedby="color_code" value="{{$variantProduct->color_code}}"
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <input type="hidden" name="gallery" value="{{ $variantProduct->gallery }}" id="gallery" 
                                    class="@error('gallery')
                                                is-invalid
                                            @enderror">
                        ...
                        <div class="col-3">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_product" id="id_product">
                                    @foreach ($product as $prod)
                                        @if ($prod->id == $variantProduct->id_product)
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity" id="quantity" aria-describedby="quantity" value="{{ $variantProduct->quantity }}" placeholder="quantity" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  name="price" id="price" aria-describedby="price" value="{{ $variantProduct->price }}"   placeholder="Price"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  name="discount" id="discount" aria-describedby="discount"  value="{{ $variantProduct->discount }}" placeholder="Discount"
