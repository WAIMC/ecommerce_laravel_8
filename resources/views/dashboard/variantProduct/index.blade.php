            ...
            <div class="card shadow">
                ...
                <div class="card-header">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-4">
                            <h4>Variant Product Management</h4>
                        </div>
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered table-hover text-center">
                        ...
                        <tbody>
                            @foreach ($data_vp as $prod)
                                <tr>
                                    <td scope="row">{{ $prod->id }}</td>
                                    <td>{{ $prod->id_product }}</td>
                                    <td>{{ $prod->color }}</td>
                                    <td><span class="badge badge-primary border-2" style="background: {{ $prod->color_code }}">Color Code</span> </td>
                                    <td>
                                        <span class="badge badge-danger"> <del>${{$prod->price}}</del> </span>
                                    ...
                                    <td>
                                        <a href="{{ route('variantProduct.edit', $prod->id) }}" class="btn btn-info">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('variantProduct.destroy', $prod->id) }}"
                ...
                <div class="card-footer text-muted">
                    <div class="row">
                        <div class="col-5">
                            <h6>Showing 1 to 10 of {{ $data_vp->count() }} entries</h6>
                        </div>
                        <div class="col-7">
                            {{ $data_vp->appends(request()->all())->links() }}
                        </div>
                    </div>
                </div>
            </div>
