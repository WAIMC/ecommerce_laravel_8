        ...
        <div class="col-12">
            <div class="card shadow">
                        ...
                        <tbody>
                            @foreach ($data_product as $prod)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{url('public/uploads/product/'.$prod->image)}}" width="100%" alt="">
                                    </td>
                                    <td>
                                        @if ($prod->status == 0)
                                    ...
                                    <td>
                                        <a href="{{ route('product.edit', $prod->id) }}" class="btn btn-info">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('product.destroy', $prod->id) }}"
                ...
                <div class="card-footer text-muted">
                    <div class="row">
                        <div class="col-5">
                            <h6>Showing 1 to 10 of {{ $data_product->count() }} entries</h6>
                        </div>
                        <div class="col-7">
