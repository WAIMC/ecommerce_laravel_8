...
@section('main')
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data" id="formEdit">
                    @csrf @method('PUT')
                    <div class="row">
                        <div class="col-9">
                            ...
                            <button type="button" class="btn btn-primary btnEdit">Add</button>
                        ...
                        <div class="col-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" aria-describedby="title" placeholder="Title"
                                    value="{{ $blog->title }}" class="form-control @error('title')
                                          is-invalid
                                    @enderror">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="author" value="{{Auth::guard('adminAuth')->user()->name}}" id="author" aria-describedby="author" placeholder="Author"
                                    value="{{ $blog->author }}" class="form-control @error('author')
                                          is-invalid
                                    @enderror">
                                @error('author')
