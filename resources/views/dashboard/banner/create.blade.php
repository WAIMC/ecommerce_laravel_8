            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6 m-auto">
                        <form action="{{ route('banner.store') }}" id="formInsert" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="name">Name Banner</label>
                                <input type="text"  name="name" id="name" aria-describedby="nameBanner" placeholder="Name Banner" value="{{ old('name')}}" required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="subtitle" id="subtitle" aria-describedby="subtitleBanner" placeholder="Subtitle Banner" value="{{ old('subtitle')}}" required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="title_first" id="title_first" aria-describedby="title_firstBanner" placeholder="Title first Banner" value="{{ old('title_first')}}" required 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title_second" id="title_second" aria-describedby="title_secondBanner" placeholder="Title Second Banner" value="{{ old('title_second')}}" required
