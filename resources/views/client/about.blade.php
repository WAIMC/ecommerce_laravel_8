                ...
                <div class="col-md-6">
                    <div class="about-img" data-aos="fade-up"  data-aos-delay="0">
                        <div class="img-responsive">
                            <img src="{{ url('public/client') }}/images/about/img-about.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        ...
                        <div class="image">
                                <img src="{{ url('public/client') }}/images/icons/icon_about1.jpg" alt="">
                        </div>
                            <div class="content">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        ...
                        <div class="image">
                                <img src="{{ url('public/client') }}/images/icons/icon_about2.jpg" alt="">
                        </div>
                            <div class="content">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        ...
                        <div class="image">
                                <img src="{{ url('public/client') }}/images/icons/icon_about3.jpg" alt="">
                        </div>
                            <div class="content">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        ...
                        <div class="image">
                                <img src="{{ url('public/client') }}/images/icons/icon_about4.jpg" alt="">
                        </div>
                            <div class="content">
                ...
                <div class="row mb-n6">
                    <div class="col-xl-3 mb-5">
                        <div class="team-single" data-aos="fade-up"  data-aos-delay="0">
                            <div class="team-img">
                                <img class="img-fluid" src="{{ url('public/client') }}/images/team/leader1.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-3 mb-5">
                        <div class="team-single" data-aos="fade-up"  data-aos-delay="200">
                            <div class="team-img">
                                <img class="img-fluid" src="{{ url('public/client') }}/images/team/leader2.png" alt="">
                            </div>
                            <div class="team-content">
                    ...
                    <div class="col-xl-3 mb-5">
                        <div class="team-single" data-aos="fade-up"  data-aos-delay="400">
                            <div class="team-img">
                                <img class="img-fluid" src="{{ url('public/client') }}/images/team/leader3.png" alt="">
                            </div>
                            <div class="team-content">
                                <h6 class="team-name font--bold mt-5">Missa Santos</h6>
                    ...
                    <div class="col-xl-3 mb-5">
                        <div class="team-single" data-aos="fade-up"  data-aos-delay="600">
                            <div class="team-img">
                                <img class="img-fluid" src="{{ url('public/client') }}/images/team/leader4.png" alt="">
                            </div>
                            <div class="team-content">
                            ...
                            <div class="swiper-container company-logo-slider">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img  class="img-fluid" src="{{ url('public/client') }}/images/company-logo/company-logo-1.png" alt=""></div>
                                    </div>
                                    <!-- End Company Logo Single Item -->
                                    <!-- Start Company Logo Single Item -->
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid" src="{{ url('public/client') }}/images/company-logo/company-logo-2.png" alt=""></div>
                                    </div>
                                    <!-- End Company Logo Single Item -->
                                    <!-- Start Company Logo Single Item -->
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid" src="{{ url('public/client') }}/images/company-logo/company-logo-3.png" alt=""></div>
                                    </div>
                                    <!-- End Company Logo Single Item -->
                                    <!-- Start Company Logo Single Item -->
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid" src="{{ url('public/client') }}/images/company-logo/company-logo-4.png" alt=""></div>
                                    </div>
                                    <!-- End Company Logo Single Item -->
                                    <!-- Start Company Logo Single Item -->
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid" src="{{ url('public/client') }}/images/company-logo/company-logo-5.png" alt=""></div>
                                    </div>
                                    <!-- End Company Logo Single Item -->
                                    <!-- Start Company Logo Single Item -->
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid" src="{{ url('public/client') }}/images/company-logo/company-logo-6.png" alt=""></div>
                                    </div>
                                    <!-- End Company Logo Single Item -->
                                    <!-- Start Company Logo Single Item -->
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid" src="{{ url('public/client') }}/images/company-logo/company-logo-7.png" alt=""></div>
                                    </div>
                                    <!-- End Company Logo Single Item -->
                                    <!-- Start Company Logo Single Item -->
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid" src="{{ url('public/client') }}/images/company-logo/company-logo-8.png" alt=""></div>
                                    </div>
                                    <!-- End Company Logo Single Item -->
                                </div>
                            </div>
